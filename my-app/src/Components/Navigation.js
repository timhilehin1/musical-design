...
function Navigation(){
    return (
        <>
          <div className="home-nav d-none d-lg-block mt-5  p-2">
            <div>
            <AiFillHome style={{fontSize:"1.5rem", color:"#FACD66"}}/>
            </div>

      <Link to ="/Album" > <svg class="sidebar-icon" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
